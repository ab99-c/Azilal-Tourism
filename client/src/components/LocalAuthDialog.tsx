...
const labels = {
  ar: { login: 'تسجيل الدخول', register: 'إنشاء حساب', activate: 'تفعيل حساب الإدارة', intro: 'استعمل بريدك الإلكتروني وكلمة السر ديال ADRAR.', name: 'الاسم الكامل', email: 'البريد الإلكتروني', password: 'كلمة السر', secret: 'رمز الإعداد الإداري', submitLogin: 'دخول', submitRegister: 'إنشاء الحساب', submitActivate: 'تفعيل الإدارة', switchRegister: 'ما عندكش حساب؟ أنشئ واحد', switchLogin: 'عندك حساب؟ دخل', admin: 'عندك حساب الإدارة القديم؟ فعّلو هنا', back: 'رجوع للدخول', working: 'كنعالجو…', passwordHint: '10 حروف على الأقل', accountExists: 'هاد الإيميل عندو حساب من قبل. دخل بكلمة السر، أو فعّل حساب الإدارة إذا كان حسابك القديم.', invalid: 'الإيميل أو كلمة السر أو رمز الإعداد غير صحيحين.', activated: 'تفعّل حساب الإدارة. دابا تقدر تدخل بالإيميل وكلمة السر.' },
  en: { login: 'Sign in', register: 'Create account', activate: 'Activate administrator account', intro: 'Use your ADRAR email and password.', name: 'Full name', email: 'Email address', password: 'Password', secret: 'Administrator setup secret', submitLogin: 'Sign in', submitRegister: 'Create account', submitActivate: 'Activate administrator account', switchRegister: 'New here? Create an account', switchLogin: 'Have an account? Sign in', admin: 'Have the existing administrator account? Activate it here', back: 'Back to sign in', working: 'Please wait…', passwordHint: 'At least 10 characters', accountExists: 'This email already has an account. Sign in, or activate it if it is the existing administrator account.', invalid: 'The email or password is incorrect.', activated: 'Administrator account activated. You can now sign in with email and password.' },
  fr: { login: 'Se connecter', register: 'Créer un compte', activate: 'Activer le compte administrateur', intro: 'Utilisez votre e-mail et mot de passe ADRAR.', name: 'Nom complet', email: 'Adresse e-mail', password: 'Mot de passe', secret: 'Code de configuration administrateur', submitLogin: 'Se connecter', submitRegister: 'Créer le compte', submitActivate: 'Activer le compte administrateur', switchRegister: 'Nouveau ? Créer un compte', switchLogin: 'Déjà un compte ? Se connecter', admin: 'Vous avez le compte administrateur existant ? Activez-le ici', back: 'Retour à la connexion', working: 'Traitement…', passwordHint: '10 caractères au minimum', accountExists: 'Cet e-mail a déjà un compte. Connectez-vous, ou activez-le s’il s’agit du compte administrateur existant.', invalid: 'L’e-mail ou le mot de passe est incorrect.', activated: 'Compte administrateur activé. Vous pouvez maintenant vous connecter avec votre e-mail et mot de passe.' },
  ber: { login: 'ⴽⵛⵎ', register: 'ⵙⵏⵓⵍⴼⵓ ⴰⵎⵉⴷⴰⵏ', activate: 'ⵙⵙⵏ ⴰⵎⵉⴷⴰⵏ ⵏ ⵓⵏⴱⴷⴰⴷ', intro: 'ⵙⵙⵎⵔⵙ ⵉⵎⵉⵍ ⵏⵏⴽ ⴷ ⵜⴰⵡⴰⵍⵜ ⵏ ADRAR.', name: 'ⵉⵙⵎ ⵏⵏⴽ', email: 'ⵉⵎⵉⵍ', password: 'ⵜⴰⵡⴰⵍⵜ', secret: 'ⴰⵎⵣⵔⵓⵢ ⵏ ⵓⵙⵏⵓⵍⴼⵓ ⵏ ⵓⵏⴱⴷⴰⴷ', submitLogin: 'ⴽⵛⵎ', submitRegister: 'ⵙⵏⵓⵍⴼⵓ ⴰⵎⵉⴷⴰⵏ', submitActivate: 'ⵙⵙⵏ ⴰⵎⵉⴷⴰⵏ ⵏ ⵓⵏⴱⴷⴰⴷ', switchRegister: 'ⵓⵔ ⴷⴰⵔⴽ ⴰⵎⵉⴷⴰⵏ? ⵙⵏⵓⵍⴼⵓ ⵢⴰⵏ', switchLogin: 'ⴷⴰⵔⴽ ⴰⵎⵉⴷⴰⵏ? ⴽⵛⵎ', admin: 'ⴷⴰⵔⴽ ⴰⵎⵉⴷⴰⵏ ⵏ ⵓⵏⴱⴷⴰⴷ? ⵙⵙⵏⵉⵜ ⴷⴰ', back: 'ⵔⵔ ⵖⵔ ⵓⴽⵛⵓⵎ', working: 'ⵉⵜⵜⵓⵙⵡⵓⵔ…', passwordHint: '10 ⵉⵙⴽⴽⵉⵍⵏ ⵖ ⵓⴳⴳⴰⵔ', accountExists: 'ⵉⵎⵉⵍ ⴰⴷ ⵉⵍⴰ ⴰⵎⵉⴷⴰⵏ. ⴽⵛⵎ ⵏⵖ ⵙⵙⵏ ⴰⵎⵉⴷⴰⵏ ⵏ ⵓⵏⴱⴷⴰⴷ.', invalid: 'ⵉⵎⵉⵍ ⵏⵖ ⵜⴰⵡⴰⵍⵜ ⵓⵔ ⵉⵙⵖⵓⴷⴰ.', activated: 'ⵉⵜⵜⵓⵙⵙⵏ ⵓⵎⵉⴷⴰⵏ ⵏ ⵓⵏⴱⴷⴰⴷ. ⵜⵣⵎⵔⴷ ⴰⴷ ⵜⴽⵛⵎⴷ ⵙ ⵉⵎⵉⵍ ⴷ ⵜⴰⵡⴰⵍⵜ.' },
} as const;
...
export default function LocalAuthDialog() {
  ...
  const [mode, setMode] = useState<Mode>(() =>
    new URLSearchParams(window.location.search).get('auth') === 'activate-admin' ? 'activate' : 'login'
  );
  ...
  useEffect(() => {
    ...
    if (authIntent === 'login' || authIntent === 'activate-admin') {
      setMode(authIntent === 'activate-admin' ? 'activate' : 'login');
      show();
    }
